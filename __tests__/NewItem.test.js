...
import NewItem, { CREATE_ITEM_MUTATION } from '../components/NewItem';
...
describe('<NewItem/>', () => {
  ...
  it('uploads a file when changed', async () => {
    ...
    await wait();
    const component = wrapper.find('NewItem').instance();
  ...
  it('handles state updating', async () => {
    ...
    expect(wrapper.find('NewItem').instance().state).toMatchObject({
      title: 'Testing',
      price: 50000,
